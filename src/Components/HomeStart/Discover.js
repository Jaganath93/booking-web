        ...
        <div className="container mb-5">
            <div className="row">
                ...
                <div className="col-12 col-xl-7 text-center text-white py-xl-5 my-xl-5">
                    <h1 className="display-2 display-md--1 fw-bold">A World of Luxury Awaits You</h1>
                    <h5 className="fw-bold fw-md-bolder mt-3">Discover a New Look of Luxury Resorts</h5>
                    <button className="btn btn-dark mt-2 rounded-5 fw-bold">Discover More</button>
                </div>
            </div>
        </div>
    );
