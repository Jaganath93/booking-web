        ...
        <div className="container-fluid px-lg-5" >
           ...
           <div>
            <div className="row">
                ...
                <div className="col-6 col-md-4 col-xl-2 d-flex flex-column">
                    <div className="h-100 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width={'100%'} height={"50"} role="button" fill="currentColor" class="bi bi-arrow-right-circle-fill text-primary btn-round mt-5" viewBox="0 0 16 16">
